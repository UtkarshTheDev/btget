...
describe('Download Integration Tests', () => {
  ...
  describe('download workflow', () => {
    it('should start download process for valid torrent', async () => {
      ...
      for (const torrent of testTorrents) {
        ...
        try {
          ...
          expect(output).toMatch(/Processing torrent file:|Torrent loaded:|getPeers called/);
    ...
    it('should create output directory if it does not exist', async () => {
      ...
      try {
        const testTorrent = 'test_folder-d984f67af9917b214cd8b6048ab5624c7df6a07a.torrent';
    ...
    it('should show progress information during download', async () => {
      try {
        ...
        if (hasProgress) {
          ...
          console.log('⚠️  Progress display test - no progress indicators found');
        }
